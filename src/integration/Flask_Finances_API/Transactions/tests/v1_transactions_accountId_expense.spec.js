...
describe('Transactions', () => {
    describe('POST /v1/transactions/{accountId}/expense', () => {
        it('@contract - deve validar o contrato de retorno de sucesso do serviço de criação de transação de saída', async () => {
        ...
        it('@contract - deve validar o contrato de retorno de erro do serviço de criação de transação de saída', async () => {
            const userData = apiDataLoad('users', 'valid');
            const token = await generateBearerToken(userData);
            const accountData = apiDataLoad('accounts', 'valid');
        ...
        it('deve retornar um erro ao tentar criar uma transação com uma categoria de entrada', async () => {
            ...
            const expectedError = apiDataLoad('default_errors', 'incorrect_expense_category');
