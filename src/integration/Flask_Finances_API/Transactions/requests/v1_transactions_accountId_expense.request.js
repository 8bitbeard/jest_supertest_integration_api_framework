...
class ExpenseTransactionRequest {
    ...
    constructor() {
        ...
        this.endpointPath = '/v1/transactions/{accountId}/expense'
    }

    async createExpenseTransaction({ value, category }, { id }, token = null) {
...
export default new ExpenseTransactionRequest;